...
import { Branch, defaultBranches, PostCategory, postCategories, Post, PostAttachment, UserProfile } from '@/types'; 
...
import { getBranches } from '@/lib/supabase-utils';
...
const postFormSchema = z.object({
  ...
  category: z.enum(["event", "news", "link", "note", "schedule"], { required_error: "Please select a category." }),

...
const AlumniCard: React.FC<AlumniCardProps> = ({
  ...
  return (
    <div className={`alumni-card ${activeSection !== '#about' ? 'is-active' : ''}`} data-state={activeSection}>
      <div className="card-header">
        <div
          className="card-cover"
          style={{ backgroundImage: `url('${coverUrl}')` }}
        />
        <img className="card-avatar" src={avatarUrl} alt="avatar" />
      ...
      <div className="card-main">
        <div className={`card-section ${activeSection === '#about' ? 'is-active' : ''}`} id="about">
          <div className="card-content">
            ...
            {(placementJobTitle || placementCompany) && (
              <div style={{ marginTop: '16px' }}>
                <div className="card-subtitle" style={{ fontSize: '12px', marginBottom: '8px' }}>WORKING DETAILS</div>
                <p className="card-desc" style={{ fontSize: '14px', margin: '0' }}>
                  {placementJobTitle && placementCompany
                    ? `${placementJobTitle} at ${placementCompany}`
                    : placementJobTitle || placementCompany}
                </p>
              </div>
            )}
        ...
        <div className={`card-section ${activeSection === '#skills' ? 'is-active' : ''}`} id="skills">
          <div className="card-content">
            ...
            {skills && skills.length > 0 ? (
              ...
              <p className="card-desc" style={{ fontStyle: 'italic', color: '#999' }}>No skills listed</p>
            )}
          </div>
        </div>
        ...
        <div className={`card-section ${activeSection === '#contact' ? 'is-active' : ''}`} id="contact">
          <div className="card-content">
            ...
            <div className="card-social" style={{ marginTop: '20px' }}>

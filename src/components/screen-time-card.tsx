...
export const ScreenTimeCard = ({
  ...
  return (
    <div
      className={cn(
        "w-full max-w-md rounded-2xl border border-white/10 bg-white/5 dark:bg-black/5 backdrop-blur-xl shadow-2xl px-5 py-4",
        className
      )}
    >
      <div className="flex gap-12">
        ...
        <div className="flex-1">
          ...
          <div className="mb-3 text-3xl font-semibold">
            ...
            <div className="text-sm font-normal text-muted-foreground mt-1">Attendance Rate</div>
          </div>
        ...
        {/* Vertical divider */}
        <div className="w-px bg-white/20 self-stretch relative left-6" />

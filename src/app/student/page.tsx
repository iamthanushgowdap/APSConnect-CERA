...
export default function StudentDashboardPage() {
  ...
  const allTools = [
      { title: "AI Assistant (Cera.Ai)", description: "Chat with our intelligent AI assistant for instant answers about your classes, attendance, and academic information.", icon: <Bot className="h-10 w-10 text-accent" />, link: "/cera-assistant", actionText: "Chat with AI", disabled: studentUser?.role === 'pending' },

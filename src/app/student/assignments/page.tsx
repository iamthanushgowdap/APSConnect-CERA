...
export default function StudentAssignmentsPage() {
  ...
  const fetchAndFilterAssignments = useCallback(async () => {
    ...
    try {
      console.log('Student assignments: Fetching from database for branch:', studentDetails.branch, 'semester:', studentDetails.semester);
      const assignments = await getAssignments({ 
        branch: studentDetails.branch, 
        semester: studentDetails.semester 
      });
      console.log('Student assignments: Fetched assignments:', assignments);

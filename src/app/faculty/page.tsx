...
import { Users, UserCircle, ShieldCheck, FileText, FilePlus2, ArrowRight, Newspaper, CalendarClock, BookOpen, ListChecks, Wrench, Sparkles, BookMarked, UserCheck, CreditCard, BrainCircuit, Handshake, Briefcase, BarChart, HandCoins, Bot } from "lucide-react";
...
export default function FacultyDashboardPage() {
  ...
  const allTools = [
    { title: "AI Assistant (Cera.Ai)", description: "Chat with our intelligent AI assistant for instant answers about your classes, attendance, and student data.", icon: <Bot />, link: "/cera-assistant", actionText: "Chat with AI" },

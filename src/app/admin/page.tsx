...
import { BarChart3, FilePlus2, Users, Settings, ShieldCheck, UserCircle, ArrowRight, Newspaper, CalendarClock, BookOpen, ListChecks, Wrench, Sparkles, UserCheck, CreditCard, Clock, Bot } from "lucide-react";
...
export default function AdminDashboardPage() {
  ...
  const allTools = [
    { title: "AI Assistant (Cera.Ai)", description: "Chat with our intelligent AI assistant for instant answers about timetables, attendance, and student data.", icon: <Bot />, link: "/cera-assistant", actionText: "Chat with AI" },

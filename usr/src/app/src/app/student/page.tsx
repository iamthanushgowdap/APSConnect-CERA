...
export default function StudentDashboardPage() {
  ...
  const allTools = [
      ...
      { title: "Skill Build Courses", description: "Enroll in new courses and enhance your skills.", icon: <Briefcase className="h-10 w-10 text-accent" />, link: "/student/skill-build-courses", actionText: "View Courses", disabled: studentUser?.role === 'pending' },
      { title: "Alumni & Placements", description: "Connect with alumni and explore career opportunities.", icon: <Briefcase className="h-10 w-10 text-accent" />, link: "/placements", actionText: "Browse Alumni", disabled: studentUser?.role === 'pending' },

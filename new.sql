...
\restrict m3fiRAOpse1QhL4Tft19vp0sOIuqNNEoDVKhWmi5GiTXZLm3lWHOfoakJ3rqYZx
...
--
-- Name: update_attendance_records_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.update_attendance_records_updated_at() RETURNS trigger
    ...
    AS $$
BEGIN
  -- if your attendance_records table uses a column named updated_at:
  BEGIN
    NEW.updated_at := now();
...
ALTER FUNCTION public.update_attendance_records_updated_at() OWNER TO postgres;

--
-- Name: update_campaign_amount(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_campaign_amount() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: update_fundraising_campaigns_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_fundraising_campaigns_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  BEGIN
...
ALTER FUNCTION public.update_fundraising_campaigns_updated_at() OWNER TO postgres;
...
CREATE FUNCTION public.update_updated_at_column() RETURNS trigger
    ...
    AS $$
BEGIN
  -- try common timestamp column names; ignore if not present
  BEGIN NEW.updated_at := now(); EXCEPTION WHEN undefined_column THEN NULL; END;
  BEGIN NEW."updatedAt" := now(); EXCEPTION WHEN undefined_column THEN NULL; END;
  BEGIN NEW.updatedat := now(); EXCEPTION WHEN undefined_column THEN NULL; END;
  RETURN NEW;
END;
$$;
...
CREATE TABLE public.assignments (
    ...
    submission_type text DEFAULT 'file'::text,
    instructions text,
    ...
    CONSTRAINT assignments_submission_type_check CHECK ((submission_type = ANY (ARRAY['file'::text, 'text'::text, 'link'::text])))
);
...
--
-- Name: fee_records; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.fee_records (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT fee_records_payment_status_check CHECK ((payment_status = ANY (ARRAY['pending'::text, 'partial'::text, 'paid'::text, 'overdue'::text])))
);
...
--
-- Name: fundraising_campaigns; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.fundraising_campaigns (
    ...
    title text NOT NULL,
    description text,
    "goalAmount" numeric(10,2) DEFAULT 0 NOT NULL,
    ...
    "createdByUid" text,
    CONSTRAINT fundraising_campaigns_status_check CHECK ((status = ANY (ARRAY['active'::text, 'completed'::text, 'cancelled'::text]))),
    CONSTRAINT valid_amounts CHECK ((("goalAmount" > (0)::numeric) AND ("currentAmount" >= (0)::numeric))),
    CONSTRAINT valid_dates CHECK (("endDate" >= "startDate"))
);


ALTER TABLE public.fundraising_campaigns OWNER TO postgres;
...
CREATE TABLE public.group_members (
    ...
    CONSTRAINT group_members_role_check CHECK ((role = ANY (ARRAY['admin'::text, 'faculty'::text, 'student'::text])))
);
...
CREATE TABLE public.group_messages (
    ...
    CONSTRAINT group_messages_message_type_check CHECK ((message_type = ANY (ARRAY['text'::text, 'image'::text, 'video'::text, 'audio'::text, 'document'::text, 'file'::text])))
);
...
CREATE TABLE public.groups (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT groups_type_check CHECK ((type = ANY (ARRAY['official'::text, 'student'::text])))
);
...
--
-- Name: mentorship_requests; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.notifications (
    ...
    CONSTRAINT notifications_type_check CHECK ((type = ANY (ARRAY['assignment_deadline'::text, 'fee_due'::text, 'low_attendance'::text, 'timetable_update'::text, 'fundraising_campaign'::text])))
);
...
CREATE TABLE public.reports (
    ...
    recipient_uid text,
    recipient_name text,
    CONSTRAINT reports_recipient_type_check CHECK (("recipientType" = ANY (ARRAY['faculty'::text, 'admin'::text]))),
    CONSTRAINT reports_status_check CHECK ((status = ANY (ARRAY['new'::text, 'viewed'::text, 'resolved'::text, 'archived'::text])))
);
...
--
-- Name: student_fundraising_status; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.student_fundraising_status (
    ...
    remarks text,
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT student_fundraising_status_status_check CHECK ((status = ANY (ARRAY['paid'::text, 'not_paid'::text, 'pending'::text])))
);


ALTER TABLE public.student_fundraising_status OWNER TO postgres;
...
CREATE TABLE public.subjects (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT subjects_type_check CHECK ((type = ANY (ARRAY['class'::text, 'lab'::text])))
);
...
CREATE TABLE public.user_preferences (
    ...
    CONSTRAINT user_preferences_language_check CHECK ((language = ANY (ARRAY['en'::text, 'hi'::text, 'kn'::text, 'te'::text]))),
...
CREATE TABLE public.user_profiles (
    ...
    location text,
    CONSTRAINT user_profiles_role_check CHECK ((role = ANY (ARRAY['student'::text, 'faculty'::text, 'admin'::text, 'pending'::text, 'alumni'::text, 'rejected'::text])))
);
...
--
-- Name: attendance_records attendance_records_student_uid_subject_date_period_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_records
    ADD CONSTRAINT attendance_records_student_uid_subject_date_period_key UNIQUE (student_uid, subject, date, period);
...
--
-- Name: fee_records fee_records_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fundraising_campaigns fundraising_campaigns_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mentorship_requests mentorship_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: student_fundraising_status student_fundraising_status_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_fundraising_status
    ADD CONSTRAINT student_fundraising_status_pkey PRIMARY KEY (id);
...
--
-- Name: timetables timetables_branch_semester_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.timetables
    ADD CONSTRAINT timetables_branch_semester_key UNIQUE (branch, semester);
...
--
-- Name: student_fundraising_status unique_student_campaign; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_fundraising_status
    ADD CONSTRAINT unique_student_campaign UNIQUE (campaign_id, student_uid);


--
-- Name: subjects unique_subject_code; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subjects
    ADD CONSTRAINT unique_subject_code UNIQUE (branch, semester, code);
...
--
-- Name: user_profiles user_profiles_student_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_assignments_branch; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assignments_branch ON public.assignments USING btree (branch);


--
-- Name: idx_assignments_branch_semester; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assignments_branch_semester ON public.assignments USING btree (branch, semester);


--
-- Name: idx_assignments_course_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_assignments_semester; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assignments_semester ON public.assignments USING btree (semester);


--
-- Name: idx_reports_submitted_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_reports_submitted_at ON public.reports USING btree ("submittedAt" DESC);


--
-- Name: idx_reports_submitted_by_uid; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_reports_submitted_by_uid ON public.reports USING btree ("submittedByUid");


--
-- Name: idx_study_materials_branch; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_study_materials_branch ON public.study_materials USING btree (branch);


--
-- Name: idx_study_materials_created_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_study_materials_semester; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_study_materials_semester ON public.study_materials USING btree (semester);


--
-- Name: idx_study_materials_uploaded_by; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_timetables_branch; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_timetables_branch ON public.timetables USING btree (branch);


--
-- Name: idx_timetables_branch_semester; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_timetables_branch_semester ON public.timetables USING btree (branch, semester);


--
-- Name: idx_timetables_semester; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_timetables_semester ON public.timetables USING btree (semester);


--
-- Name: idx_user_profiles_branch; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_profiles_branch ON public.user_profiles USING btree (branch);


--
-- Name: idx_user_profiles_placement_company; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_profiles_placement_company ON public.user_profiles USING btree (placement_company);


--
-- Name: idx_user_profiles_semester; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_profiles_semester ON public.user_profiles USING btree (semester);


--
-- Name: idx_user_profiles_usn; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_profiles_usn ON public.user_profiles USING btree (usn);
...
--
-- Name: fee_records update_fee_records_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: fundraising_campaigns update_fundraising_campaigns_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_fundraising_campaigns_updated_at BEFORE UPDATE ON public.fundraising_campaigns FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: group_messages update_group_messages_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_group_messages_updated_at BEFORE UPDATE ON public.group_messages FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: mentorship_requests update_mentorship_requests_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: student_fundraising_status update_student_fundraising_status_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_student_fundraising_status_updated_at BEFORE UPDATE ON public.student_fundraising_status FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: timetables update_timetables_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: assignments assignments_instructor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assignments
    ADD CONSTRAINT assignments_instructor_id_fkey FOREIGN KEY (instructor_id) REFERENCES public.user_profiles(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.attendance_records
    ADD CONSTRAINT attendance_records_marked_by_fkey FOREIGN KEY (marked_by) REFERENCES public.user_profiles(id) ON DELETE SET NULL;


--
-- Name: attendance_records attendance_records_student_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_records
    ADD CONSTRAINT attendance_records_student_uid_fkey FOREIGN KEY (student_uid) REFERENCES public.user_profiles(id) ON DELETE CASCADE;
...
--
-- Name: fee_records fee_records_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fee_records
    ADD CONSTRAINT fee_records_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.user_profiles(id) ON DELETE CASCADE;


--
-- Name: study_materials fk_study_materials_uploaded_by; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.study_materials
    ADD CONSTRAINT fk_study_materials_uploaded_by FOREIGN KEY (uploaded_by) REFERENCES public.user_profiles(id) ON DELETE CASCADE;


--
-- Name: fundraising_campaigns fundraising_campaigns_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fundraising_campaigns
    ADD CONSTRAINT fundraising_campaigns_created_by_fkey FOREIGN KEY ("createdByUid") REFERENCES public.user_profiles(id) ON DELETE SET NULL;
...
--
-- Name: mentorship_requests mentorship_requests_mentee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mentorship_requests
    ADD CONSTRAINT mentorship_requests_mentee_id_fkey FOREIGN KEY (mentee_id) REFERENCES public.user_profiles(id) ON DELETE CASCADE;


--
-- Name: mentorship_requests mentorship_requests_mentor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mentorship_requests
    ADD CONSTRAINT mentorship_requests_mentor_id_fkey FOREIGN KEY (mentor_id) REFERENCES public.user_profiles(id) ON DELETE CASCADE;
...
--
-- Name: reports reports_resolved_by_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reports
    ADD CONSTRAINT reports_resolved_by_uid_fkey FOREIGN KEY ("resolvedByUid") REFERENCES public.user_profiles(id) ON DELETE SET NULL;


--
-- Name: reports reports_submitted_by_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reports
    ADD CONSTRAINT reports_submitted_by_uid_fkey FOREIGN KEY ("submittedByUid") REFERENCES public.user_profiles(id) ON DELETE CASCADE;


--
-- Name: student_fundraising_status student_fundraising_status_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_fundraising_status
    ADD CONSTRAINT student_fundraising_status_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.fundraising_campaigns(id) ON DELETE CASCADE;
...
--
-- Name: user_profiles user_profiles_approved_by_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_profiles
    ADD CONSTRAINT user_profiles_approved_by_uid_fkey FOREIGN KEY (approved_by_uid) REFERENCES public.user_profiles(id) ON DELETE SET NULL;


--
-- Name: user_profiles user_profiles_rejected_by_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_profiles
    ADD CONSTRAINT user_profiles_rejected_by_uid_fkey FOREIGN KEY (rejected_by_uid) REFERENCES public.user_profiles(id) ON DELETE SET NULL;
...
--
-- Name: fee_records Allow all operations on fee_records; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow all operations on fee_records" ON public.fee_records USING (true) WITH CHECK (true);


--
-- Name: reports Allow all operations on reports; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow all operations on reports" ON public.reports USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all operations on user_profiles" ON public.user_profiles USING (true) WITH CHECK (true);


--
-- Name: branches Allow anyone to read branches; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow anyone to read branches" ON public.branches FOR SELECT USING (true);


--
-- Name: subjects Allow authenticated users to read subjects; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: timetables Allow authenticated users to read timetables; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow authenticated users to read timetables" ON public.timetables FOR SELECT USING ((auth.role() = 'authenticated'::text));
...
--
-- Name: notifications Service role can manage all notifications; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: assignments Students can view assignments for their branch and semester; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Students can view assignments for their branch and semester" ON public.assignments FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.user_profiles up
  WHERE ((up.id = (auth.uid())::text) AND (up.role = 'student'::text) AND (up.is_approved = true) AND (up.branch = assignments.branch) AND (up.semester = assignments.semester)))));


--
-- Name: attendance_records Students can view own attendance; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Students can view own attendance" ON public.attendance_records FOR SELECT USING (((auth.uid())::text = student_uid));


--
-- Name: fundraising_campaigns Students can view relevant campaigns; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Students can view relevant campaigns" ON public.fundraising_campaigns FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.user_profiles up
  WHERE ((up.id = (auth.uid())::text) AND (up.role = 'student'::text) AND (up.branch = ANY (fundraising_campaigns.target_branches)) AND (up.semester = ANY (fundraising_campaigns.target_semesters))))));
...
--
-- Name: subjects allow authenticated to select subjects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "allow authenticated to select subjects" ON public.subjects FOR SELECT TO authenticated USING (true);


--
-- Name: timetables allow authenticated to select timetables; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "allow authenticated to select timetables" ON public.timetables FOR SELECT TO authenticated USING (true);
...
--
-- Name: fee_records authenticated select fee_records; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "authenticated select fee_records" ON public.fee_records FOR SELECT TO authenticated USING (true);


--
-- Name: groups authenticated select groups; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: job_postings authenticated select job_postings; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "authenticated select job_postings" ON public.job_postings FOR SELECT TO authenticated USING (true);


--
-- Name: reports authenticated select reports; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: study_materials authenticated select study_materials; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "authenticated select study_materials" ON public.study_materials FOR SELECT TO authenticated USING (true);
...
--
-- Name: mentorship_requests create mentorship request; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "create mentorship request" ON public.mentorship_requests FOR INSERT TO authenticated WITH CHECK ((mentee_id = (auth.uid())::text));


--
-- Name: assignments faculty can manage own assignments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "faculty can manage own assignments" ON public.assignments USING ((EXISTS ( SELECT 1
   FROM public.user_profiles up
  WHERE ((up.id = (auth.uid())::text) AND (up.role = 'faculty'::text) AND (COALESCE(up.is_approved, false) = true))))) WITH CHECK ((COALESCE(instructor_id, instructor_id) = (auth.uid())::text));


--
-- Name: attendance_records faculty manage attendance; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "faculty manage attendance" ON public.attendance_records USING ((EXISTS ( SELECT 1
   FROM public.user_profiles up
  WHERE ((up.id = (auth.uid())::text) AND (up.role = 'faculty'::text) AND (COALESCE(up.is_approved, false) = true))))) WITH CHECK (true);


--
-- Name: fee_records; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.fee_records ENABLE ROW LEVEL SECURITY;

--
-- Name: group_messages group admin delete messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "group admin delete messages" ON public.group_messages FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.group_members gm_admin
  WHERE ((gm_admin.group_id = group_messages.group_id) AND (gm_admin.user_id = (auth.uid())::text) AND (gm_admin.role = 'admin'::text)))));


--
-- Name: groups group admin manage groups; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "group admin manage groups" ON public.groups USING ((EXISTS ( SELECT 1
   FROM public.group_members gm
  WHERE ((gm.group_id = groups.id) AND (gm.user_id = (auth.uid())::text) AND (gm.role = 'admin'::text))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.group_members gm
  WHERE ((gm.group_id = groups.id) AND (gm.user_id = (auth.uid())::text) AND (gm.role = 'admin'::text)))));


--
-- Name: group_messages group admin update messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "group admin update messages" ON public.group_messages FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.group_members gm_admin
  WHERE ((gm_admin.group_id = group_messages.group_id) AND (gm_admin.user_id = (auth.uid())::text) AND (gm_admin.role = 'admin'::text))))) WITH CHECK (true);


--
-- Name: group_messages group members can insert messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "group members can insert messages" ON public.group_messages FOR INSERT TO authenticated WITH CHECK (((author_uid = (auth.uid())::text) AND (EXISTS ( SELECT 1
   FROM public.group_members gm
  WHERE ((gm.group_id = group_messages.group_id) AND (gm.user_id = (auth.uid())::text) AND ((COALESCE(gm.can_post, false) = true) OR (gm.role = ANY (ARRAY['admin'::text, 'faculty'::text]))))))));


--
-- Name: group_messages group members can select messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "group members can select messages" ON public.group_messages FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.group_members gm
  WHERE ((gm.group_id = group_messages.group_id) AND (gm.user_id = (auth.uid())::text)))));
...
--
-- Name: mentorship_requests mentors can update requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "mentors can update requests" ON public.mentorship_requests FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.user_profiles up
  WHERE ((up.id = (auth.uid())::text) AND (up.role = 'faculty'::text)))));


--
-- Name: mentorship_requests; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: fee_records owner manage fee_records; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "owner manage fee_records" ON public.fee_records USING ((student_id = (auth.uid())::text)) WITH CHECK ((student_id = (auth.uid())::text));


--
-- Name: job_postings owner manage job_postings; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "owner manage job_postings" ON public.job_postings USING ((posted_by = (auth.uid())::text)) WITH CHECK ((posted_by = (auth.uid())::text));


--
-- Name: reports owner manage reports; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "owner manage reports" ON public.reports USING (("submittedByUid" = (auth.uid())::text)) WITH CHECK (("submittedByUid" = (auth.uid())::text));
...
--
-- Name: assignments service_role can manage assignments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "service_role can manage assignments" ON public.assignments USING ((auth.role() = 'service_role'::text));


--
-- Name: admin_settings service_role manage admin_settings; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "service_role manage admin_settings" ON public.admin_settings USING ((auth.role() = 'service_role'::text));


--
-- Name: notifications service_role manage notifications; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "service_role manage notifications" ON public.notifications USING ((auth.role() = 'service_role'::text));


--
-- Name: attendance_records student can view own attendance; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "student can view own attendance" ON public.attendance_records FOR SELECT USING ((student_uid = (auth.uid())::text));


--
-- Name: student_fundraising_status student fundraising status manage own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "student fundraising status manage own" ON public.student_fundraising_status USING ((student_uid = (auth.uid())::text)) WITH CHECK ((student_uid = (auth.uid())::text));


--
-- Name: student_fundraising_status; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.student_fundraising_status ENABLE ROW LEVEL SECURITY;

--
-- Name: assignments students can select assignments for their branch/semester; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "students can select assignments for their branch/semester" ON public.assignments FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.user_profiles up
  WHERE ((up.id = (auth.uid())::text) AND (up.role = 'student'::text) AND (up.branch = assignments.branch) AND (up.semester = assignments.semester)))));
...
--
-- Name: study_materials uploader manage study_materials; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "uploader manage study_materials" ON public.study_materials USING ((uploaded_by = (auth.uid())::text)) WITH CHECK ((uploaded_by = (auth.uid())::text));


--
-- Name: user_preferences user can manage own preferences; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user can manage own preferences" ON public.user_preferences USING (((user_id)::text = (auth.uid())::text)) WITH CHECK (((user_id)::text = (auth.uid())::text));


--
-- Name: notifications user can select own notifications; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "user can select own notifications" ON public.notifications FOR SELECT USING (((user_id)::text = (auth.uid())::text));
...
--
-- Name: user_profiles users insert profile; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "users insert profile" ON public.user_profiles FOR INSERT TO authenticated WITH CHECK ((id = (auth.uid())::text));


--
-- Name: user_profiles users select own profile; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "users select own profile" ON public.user_profiles FOR SELECT USING ((id = (auth.uid())::text));


--
-- Name: user_profiles users update own profile; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "users update own profile" ON public.user_profiles FOR UPDATE USING ((id = (auth.uid())::text)) WITH CHECK ((id = (auth.uid())::text));
...
--
-- Name: FUNCTION update_attendance_records_updated_at(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_campaign_amount(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_fundraising_campaigns_updated_at(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_fundraising_campaigns_updated_at() TO anon;
GRANT ALL ON FUNCTION public.update_fundraising_campaigns_updated_at() TO authenticated;
GRANT ALL ON FUNCTION public.update_fundraising_campaigns_updated_at() TO service_role;
...
--
-- Name: TABLE fee_records; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.fee_records TO anon;
GRANT ALL ON TABLE public.fee_records TO authenticated;
GRANT ALL ON TABLE public.fee_records TO service_role;


--
-- Name: TABLE fundraising_campaigns; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.fundraising_campaigns TO anon;
GRANT ALL ON TABLE public.fundraising_campaigns TO authenticated;
GRANT ALL ON TABLE public.fundraising_campaigns TO service_role;
...
--
-- Name: TABLE mentorship_requests; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE student_fundraising_status; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.student_fundraising_status TO anon;
GRANT ALL ON TABLE public.student_fundraising_status TO authenticated;
GRANT ALL ON TABLE public.student_fundraising_status TO service_role;
...
\unrestrict m3fiRAOpse1QhL4Tft19vp0sOIuqNNEoDVKhWmi5GiTXZLm3lWHOfoakJ3rqYZx
